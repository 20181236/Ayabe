...
public class CharacterStats : MonoBehaviour
{
    ...
    public void AddBuffStat(BuffStatType stat, float value)
    {
        switch (stat)
        {
            case BuffStatType.MaxHealth: buffedMaxHealth += value; break;
            case BuffStatType.AttackPower: buffedAttackPower += value; break;
            case BuffStatType.AttackInterval: buffedAttackInterval += value; break;
            case BuffStatType.AttackRange: buffedAttackRange += value; break;
            case BuffStatType.HealPower: buffedHealPower += value; break;
        }
    }
